...
| Tab | Description |
|---|---|
| Startup Idea | Input form — name, industry, description, target users, token symbol |
| Validation | AI scores with market, competition, revenue, and risk analysis |
| Tokenomics | Token overview, distribution chart, and vesting schedule |
| Branding | Names, taglines, positioning, and visual identity concepts |
| Whitepaper | Four-section investor-grade whitepaper |
| Roadmap | Milestone grid across Month 1, 3, 6, and 12 |
| Liquidity Planner | STON.fi allocation strategy and ecosystem metrics |
| Pool Intelligence | Live pool data with recommended pool for token launch |
| Launch Score | Readiness score with sub-score breakdown |
| Mira AI | Full context handoff to Mira AI on Telegram |
...
- [TON Connect](https://docs.ton.org/develop/dapps/ton-connect/overview) — Wallet authentication
- [STON.fi DEX API](https://docs.ston.fi) — Live pool data and liquidity intelligence
- [Mira AI](https://t.me/mira_ton_bot) — Telegram-based AI co-founder
- [Anthropic Claude](https://anthropic.com) — All AI generation
